Style Guide for Modern Arcade

Project Author: Jeramiah Trout


Functions will have comment blocks directly above or docstrings inside, explaining what their purpose is as well as their general expected input(s) and output(s)
